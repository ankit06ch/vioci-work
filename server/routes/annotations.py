...
from server.image_enhance import assess_and_maybe_enhance, assess_quality, enhance_image_full
...
def enhance_project_image(
    ...
    enhanced_bytes, regions = enhance_image_full(data)
    msg = f"Clarified {regions} text region(s) on schematic"
